...
@implementation FormParamsController
                ...
                completionBlock:(CompletedPostSendLong) onCompleted
{
    ...
    [_queryBuilder appendString: @"/form/number"];
                ...
                completionBlock:(CompletedPostSendStringArray) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/string"];
                ...
                completionBlock:(CompletedPostSendModel) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/model"];
                ...
                completionBlock:(CompletedPostSendModelArray) onCompleted
{
    ...
    //load form parameters
    [_parameters addEntriesFromDictionary: @{
        @"models": (nil != models) ? models : [NSNull null]
    }];
                ...
                completionBlock:(CompletedPostSendFile) onCompleted
{
    ...
    NSError* _validationError = nil;
    if (file == nil)
        _validationError = [[APIError alloc] initWithReason: @"The parameter 'file' is a required parameter and cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
    if(_validationError != nil)
        onCompleted(NO,nil,nil,_validationError);
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/file"];
                ...
                completionBlock:(CompletedPostSendMixedArray) onCompleted
{
    ...
    if (input.file == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'file' in the input object cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
    else if (input.integers == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'integers' in the input object cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
    else if (input.models == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'models' in the input object cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
    else if (input.strings == nil)
        _validationError = [[APIError alloc] initWithReason: @"The property 'strings' in the input object cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
    if(_validationError != nil)
        onCompleted(NO,nil,nil,_validationError);
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/mixed"];
    ...
    [_parameters addEntriesFromDictionary: @{
        @"file": input.file,
        @"models": (nil != input.models) ? input.models : [NSNull null]
    }];

    //load params from primitive nonscalar arrays
    [_parameters addEntriesFromDictionary: [APIHelper prepareFormFieldsFromArrayName:@"integers" andValues:input.integers]];
    [_parameters addEntriesFromDictionary: [APIHelper prepareFormFieldsFromArrayName:@"strings" andValues:input.strings]];
                ...
                completionBlock:(CompletedPostSendIntegerEnumArray) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/integerenum"];
                ...
                completionBlock:(CompletedPostSendStringEnumArray) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/form/stringenum"];
    ...
    //load form parameters
    [_parameters addEntriesFromDictionary: @{
        @"days": (nil != days) ? days : [NSNull null]
    }];
